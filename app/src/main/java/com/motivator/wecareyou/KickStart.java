...
public class KickStart extends FragmentActivity implements View.OnClickListener,GoogleApiClient.ConnectionCallbacks,
...
//    private GoogleApiClient mGoogleApiClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        putData = new PutData(KickStart.this);
        getData = new GetData(KickStart.this);
        updateData = new UpdateData(KickStart.this);
...
//  			checkCondition(check12, this.check);
    ...
    private void intializeUI() {
        Typeface tfMontez = Typeface.createFromAsset(KickStart.this.getAssets(), "fonts/Montez-Regular.ttf");
        Typeface tfPhilospher = Typeface.createFromAsset(KickStart.this.getAssets(), "fonts/Philosopher-Regular.ttf");
...
//        	          btnNext.requestFocus();
    ...
    public void registrationValidation() {
        ...
        if (userName == null || userName.length() <= 0)
            Toast.makeText(KickStart.this, R.string.enter_user_name, Toast.LENGTH_SHORT).show();
        else if (userEmail != null && userEmail.trim().length() > 0) {
            if (!(GeneralUtility.isValidEmail1(userEmail)))
                Toast.makeText(KickStart.this, R.string.enter_email, Toast.LENGTH_SHORT).show();
            else {
                if (GeneralUtility.isNetworkAvailable(KickStart.this)) {
...
//                    callService();
                    ...
                    GeneralUtility.PopUpInfo(KickStart.this, R.string.network_failure, R.string.no_internet);
            }
        } else {
            if (GeneralUtility.isNetworkAvailable(KickStart.this)) {
                user_age = AppsConstant.user_age;
...
//    }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if(Pref.getBoolean(getApplicationContext(),"googlesignin",false)) {
            signOut();
            revokeAccess();
        }
    }
    ...
    class RegistrationCall extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
//            Log.d("journeymode","journeymode:-"+ GeneralUtility.getPreferences(KickStart.this,"journey_mode"));
//            Log.d("journeymode","alarm:-"+alarm_time);
            progressDialog = ProgressDialog.show(KickStart.this, "Please wait...", "");
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("pro_age", AppsConstant.user_age));
            nameValuePairs.add(new BasicNameValuePair("pro_gen", AppsConstant.user_gender));
            nameValuePairs.add(new BasicNameValuePair("pro_helth_con", AppsConstant.user_health));
            nameValuePairs.add(new BasicNameValuePair("pro_email", user_email));
            nameValuePairs.add(new BasicNameValuePair("journey_type", GeneralUtility.getPreferences(KickStart.this,"journey_mode")+""));
        ...
        protected void onPostExecute(String jsonResponse) {
            ...
            try {
                ...
                if (success.equals("true")) {
                    ...
                    PrefData.setStringPref(getApplicationContext(), PrefData.GENDER_KEY, AppsConstant.user_gender);
                    PrefData.setStringPref(getApplicationContext(), PrefData.EMAIL_KEY, user_email);
...
//                    startService(new Intent(KickStart.this, ContactService.class));
//                    Intent i = new Intent(KickStart.this, Chapter1.class);
//                    startActivity(i);
//                    finish();
                    Toast.makeText(getApplicationContext(), "Registered Successful", Toast.LENGTH_SHORT).show();
                }
    ...
    public void letsDoITNow() {
        GeneralUtility.setPreferences(KickStart.this, AppsConstant.user_name, userName);
        GeneralUtility.setPreferences(KickStart.this, "user_email", userEmail);
        GeneralUtility.setPreferences(KickStart.this, "user_id", userId);
        GeneralUtility.setPreferences(KickStart.this, "user_img_url", userImgURL);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_feel_energized:
                ...
                if (GeneralUtility.getPreferences(KickStart.this, AppsConstant.user_name).equalsIgnoreCase("")) {
                    if (!isRegistering) {
                        isRegistering = true;
                        JOURNEY_MODE = AppsConstant.FEEL_ENERGIZED;
                        GeneralUtility.setPreferences(KickStart.this, "journey_mode", "" + AppsConstant.FEEL_ENERGIZED);
            ...
            case R.id.tv_lose_weight:
                if (GeneralUtility.getPreferences(KickStart.this, AppsConstant.user_name).equalsIgnoreCase("")) {
                    if (!isRegistering) {
                        ...
                        GeneralUtility.setPreferences(KickStart.this, "journey_mode", "" + AppsConstant.LOSE_WEIGHT);
            ...
            case R.id.tv_sleep_better:
                if (GeneralUtility.getPreferences(KickStart.this, AppsConstant.user_name).equalsIgnoreCase("")) {
                    if (!isRegistering) {
                        ...
                        GeneralUtility.setPreferences(KickStart.this, "journey_mode", "" + AppsConstant.SLEEP_BETTER);
                        tvFeelEnergized.setVisibility(View.GONE);
                        tvLoseWeight.setVisibility(View.GONE);
...
//                    googlePlusLogin();
                    signIn();
                    //GeneralUtility.setPreferences(KickStart.this, "google_connected", "true");
                } else
                    Toast.makeText(KickStart.this, R.string.network_failure, Toast.LENGTH_SHORT).show();
                break;
...
//            updateUI(false);
    ...
    private void setAlarm(String selectedRitual, String remTime) {
        ...
        GeneralUtility.setAlarmTime(KickStart.this, userName, selectedRitual, Calendar.MONDAY, hourOfDay, minute, timeStamp, false);
        ...
        GeneralUtility.setAlarmTime(KickStart.this, userName, selectedRitual, Calendar.TUESDAY, hourOfDay, minute, timeStamp, false);
        putData.addReminderDesc(remID, userName, remTime, TableAttributes.REMINDER_TUE, TableAttributes.ON, timeStamp);

        tsLong = System.currentTimeMillis() / 1000;
        timeStamp = tsLong.intValue() + r.nextInt(100);
        GeneralUtility.setAlarmTime(KickStart.this, userName, selectedRitual, Calendar.WEDNESDAY, hourOfDay, minute, timeStamp, false);
        putData.addReminderDesc(remID, userName, remTime, TableAttributes.REMINDER_WED, TableAttributes.ON, timeStamp);

        tsLong = System.currentTimeMillis() / 1000;
        timeStamp = tsLong.intValue() + r.nextInt(100);
        GeneralUtility.setAlarmTime(KickStart.this, userName, selectedRitual, Calendar.THURSDAY, hourOfDay, minute, timeStamp, false);
        putData.addReminderDesc(remID, userName, remTime, TableAttributes.REMINDER_THU, TableAttributes.ON, timeStamp);

        tsLong = System.currentTimeMillis() / 1000;
        timeStamp = tsLong.intValue() + r.nextInt(100);
        GeneralUtility.setAlarmTime(KickStart.this, userName, selectedRitual, Calendar.FRIDAY, hourOfDay, minute, timeStamp, false);
